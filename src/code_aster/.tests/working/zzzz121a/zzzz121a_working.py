...
from code_aster.Supervis import CO
...
from code_aster.Cata.Commands.macr_adap_mail import MACR_ADAP_MAIL
from code_aster.Cata.Commands.macr_info_mail import MACR_INFO_MAIL
from code_aster.Cata.Commands.meca_statique import MECA_STATIQUE
from code_aster.Cata.Language.SyntaxObjects import _F
from code_aster.Commands import DEBUT, DEFI_MATERIAU, AFFE_MODELE, MODI_MAILLAGE, POST_ELEM, AFFE_CHAR_MECA, \
    CALC_ERREUR, POST_RELEVE_T, INFO_EXEC_ASTER, DETRUIRE, TEST_TABLE, TEST_RESU, LIRE_MAILLAGE
...
vari = help(code_aster.Mesh())
m = code_aster.Mesh('20')
m.readAsterFile('zzzz121a.mmed')
